...
export function ProductsClient({
  ...
  async function handleBlingSync() {
    if (isSyncing) return;
    setIsSyncing(true);
    ...
    try {
      ...
      toast({
        ...
        description: `Catálogo atualizado: ${data.synced || 0} produtos importados do Bling.`,
      });
        ...
        <div className="flex flex-wrap items-start justify-between gap-4">
          ...
          <div className="flex items-center gap-2">
            <button
              ...
              disabled={isSyncing}
              className={cn(
                "flex items-center gap-2 rounded-lg border px-4 py-2 text-sm font-semibold shadow-sm transition-all",
                isSyncing
            ...
            >
              ...
              {isSyncing ? "Importando..." : "Importar do Bling"}
            </button>
            <button
                    ...
                    >
                      ...
                      <td className="px-5 py-3">
                        <div className="flex items-center gap-2">
                          ...
                          />
                          <PublishWebButton item={product} categoryCode={product.categories?.code} />
                          <DeleteProductButton
                            sku={product.sku}
                            name={product.name}
                          />
